...
class FinanceView(tk.Tk):
    ...
    def setup_gui(self):
        ...
        center_y = int((screen_height - window_height) / 7)
        ...
        self.btn_chart = tk.Button(self, text="Thống kê tài chính", font=("Times New Roman", 10, "bold"), bg="#87CEFA", activebackground="#2F4F4F", activeforeground="#FFFFFF")
